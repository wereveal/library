...
function displayDirectories(selectedPrefix) {
    ...
    $.post(goTo, posted, function(response) {
        ...
        $(resp).each(function(k, v) {
            ...
            theStuff += '<button type="submit" name="submit" value="update" class="btn btn-green btn-xs">Update</button>';
            theStuff += '<button type="submit" name="submit" value="verify-delete-dir" class="btn btn-outline-red btn-xs">Delete</button>';
